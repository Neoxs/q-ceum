...
public class MultipleChoiceQuestionImpl extends QuestionImpl implements MultipleChoiceQuestion {
	...
	protected EClass eStaticClass() {
		return QcmPackage.Literals.MULTIPLE_CHOICE_QUESTION;
	}
	 ...
	 */
	@Override
	public boolean atLeastOneCorrectAnswer(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "MultipleChoiceQuestion::atLeastOneCorrectAnswer";
		try {
			/**
			 *
			 * inv atLeastOneCorrectAnswer:
			...
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, QcmPackage.Literals.MULTIPLE_CHOICE_QUESTION___AT_LEAST_ONE_CORRECT_ANSWER__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				final /*@NonInvalid*/ boolean result = OclComparableGreaterThanEqualOperation.INSTANCE.evaluate(executor, size, QcmTables.INT_1).booleanValue();
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QcmPackage.MULTIPLE_CHOICE_QUESTION___AT_LEAST_ONE_CORRECT_ANSWER__DIAGNOSTICCHAIN_MAP:
				return atLeastOneCorrectAnswer((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
