 ...
 * </p>
 * <ul>
 *   <li>{@link qcmpresentation.impl.PageImpl#getHeader <em>Header</em>}</li>
 *   <li>{@link qcmpresentation.impl.PageImpl#getCssClass <em>Css Class</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class PageImpl extends MinimalEObjectImpl.Container implements Page {
	...
	protected EClass eStaticClass() {
		return QcmpresentationPackage.Literals.PAGE;
	}
	...
	public void setHeader(String newHeader) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QcmpresentationPackage.PAGE__HEADER, oldHeader, header));
	}
	...
	public void setCssClass(String newCssClass) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QcmpresentationPackage.PAGE__CSS_CLASS, oldCssClass, cssClass));
	}
	 ...
	 */
	@Override
	public boolean headerNotEmpty(final DiagnosticChain diagnostics, final Map<Object, Object> context) {
		final String constraintName = "Page::headerNotEmpty";
		try {
			/**
			 *
			 * inv headerNotEmpty:
			 ...
			 *     then true
			 *     else
			 *       let result : Boolean[1] = header.size() > 0
			 *       in
			 *         constraintName.logDiagnostic(self, null, diagnostics, context, null, severity, result, 0)
			 *     endif
			 */
			final /*@NonInvalid*/ Executor executor = PivotUtil.getExecutor(this);
			final /*@NonInvalid*/ IntegerValue severity_0 = CGStringGetSeverityOperation.INSTANCE.evaluate(executor, QcmpresentationPackage.Literals.PAGE___HEADER_NOT_EMPTY__DIAGNOSTICCHAIN_MAP);
			...
			if (le) {
				...
				try {
					final /*@NonInvalid*/ String header = this.getHeader();
					if (header == null) {
						throw new InvalidValueException("Null \'\'String\'\' rather than \'\'OclVoid\'\' value required");
					}
					final /*@Thrown*/ IntegerValue size = StringSizeOperation.INSTANCE.evaluate(header);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QcmpresentationPackage.PAGE__HEADER:
				return getHeader();
			case QcmpresentationPackage.PAGE__CSS_CLASS:
				return getCssClass();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QcmpresentationPackage.PAGE___HEADER_NOT_EMPTY__DIAGNOSTICCHAIN_MAP:
				return headerNotEmpty((DiagnosticChain)arguments.get(0), (Map<Object, Object>)arguments.get(1));
		}
